...
- **Step 3: Execute Update Command**
  ...
  - Use the command: `aws amplify update-app --app-id d1il0ngwfwkfsdyj --repository http://github.com/symbiote-ux/schoolArk_new --access-token`
  - Replace `d1il0ngwfwkfsdyj` with your actual Amplify app ID
